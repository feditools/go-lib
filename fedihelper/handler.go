...
type (
	...
	GetAccessTokenHandler func(ctx context.Context, account Account) (accessToken string, err error)
	...
	SetAccessTokenHandler func(ctx context.Context, account Account, accessToken string) (err error)
